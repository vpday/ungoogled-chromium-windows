...
{
  "variables": {
    "chromium_version": "147.0.7727.116",
...
- Zip filenames: `dec826221d.zip` (with ARM), `89dbc21abe.zip` (without ARM)
...
- Zip filename (e.g., `dec826221d.zip` for full toolchain, `89dbc21abe.zip` for noarm)
